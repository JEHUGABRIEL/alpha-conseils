...
const WEB3FORMS_KEY = 'b37e403a-126b-4b48-b826-c60c8449cdd2';
...
export function Chatbot() {
  ...
  // Affiche le badge "1" après 2 secondes si le chat n'a pas encore été ouvert
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      if (answer) {
        ...
        const formMsg: Message = {
          text: `Je n'ai pas trouvé de réponse à votre question. Vous pouvez laisser vos coordonnées ci-dessous pour que notre équipe vous réponde directement par email.`,
          isUser: false,
          isForm: true,
        };
  ...
  const handleFormSubmitSuccess = () => {
    setMessages((prev) => [
      ...prev,
      {
        text: "✅ Merci ! Votre message a bien été transmis à notre équipe. Nous vous répondrons dans les plus brefs délais.",
        isUser: false,
      },
    ]);
    setPendingQuestion('');
  ...
  const handleFormCancel = () => {
    setMessages((prev) => [
      ...prev,
      {
        text: "Pas de problème. Vous pouvez également nous contacter par téléphone au **(+236) 75 29 89 84** ou via le formulaire de contact sur notre site.",
        isUser: false,
      },
    ]);
    setPendingQuestion('');
          ...
          >
            ...
            >
              <input
                ...
                placeholder={pendingQuestion ? 'Répondez au formulaire ci-dessus...' : 'Écrivez votre message...'}
